  ...
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%" style="position:relative;">
    ...
    <tr>
      <td align="center" style="padding:0 0 16px 0;">
        <span style="font-family:${FONTS.body};font-size:${eyebrowSize}px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:${DESIGN_TOKENS.accentLight};line-height:${Math.round(eyebrowSize * (14 / 11))}px;">${eyebrow}</span>
      </td>
    </tr>` : ""}
    <tr>
      <td align="center" style="padding:0 0 16px 0;">
        <h2 style="font-family:${FONTS.heading};font-size:${titleSize}px;font-weight:800;letter-spacing:-0.03em;line-height:1.15;color:#ffffff;margin:0;mso-line-height-rule:exactly;">${title}</h2>
      </td>
    </tr>
    ${text ? `
    <tr>
      <td align="center" style="padding:0 0 32px 0;">
        <p style="font-family:${FONTS.body};font-size:${textSize}px;line-height:1.55;color:rgba(255,255,255,0.78);margin:0 auto;max-width:420px;">${text}</p>
      </td>

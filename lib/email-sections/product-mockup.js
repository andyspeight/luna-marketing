      ...
      <tr>
        ...
        <td valign="top" align="right">
          <table role="presentation" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td bgcolor="${DESIGN_TOKENS.accent}" style="background-color:${DESIGN_TOKENS.accent};border-radius:14px 14px 4px 14px;padding:10px 14px;font-family:${FONTS.body};font-size:13px;font-weight:500;line-height:1.45;color:${DESIGN_TOKENS.primaryDark};">${text}</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr>
        <td valign="top" align="left">
          <table role="presentation" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td bgcolor="${DESIGN_TOKENS.bgTertiary}" style="background-color:${DESIGN_TOKENS.bgTertiary};border-radius:14px 14px 14px 4px;padding:10px 14px;font-family:${FONTS.body};font-size:13px;line-height:1.45;color:${DESIGN_TOKENS.textPrimary};">${text}</td>
            </tr>
          </table>
        </td>
        <td width="15%">&nbsp;</td>
...
function renderChatVariant(props) {
  ...
  const messagesHtml = messages.map(renderChatMessage).filter(Boolean).join("");
    ...
    <td bgcolor="${DESIGN_TOKENS.primary}" style="background-color:${DESIGN_TOKENS.primary};padding:14px 18px;border-radius:16px 16px 0 0;">
      <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
          ...
          <td valign="middle">
            <div style="font-family:${FONTS.body};font-size:13px;font-weight:600;color:#ffffff;line-height:18px;margin:0;">${headerName}</div>
...
function renderDashboardVariant(props) {
  ...
  const rowsHtml = rows.map(renderDashboardRow).filter(Boolean).join("");
...
<table role="presentation" border="0" cellspacing="0" cellpadding="0" width="440" align="center" style="background-color:#ffffff;border-radius:12px;border:1px solid #e2e8f0;max-width:440px;margin:0 auto;overflow:hidden;">
  <tr>
    <td bgcolor="#ffffff" style="background-color:#ffffff;padding:16px 18px;border-bottom:1px solid ${DESIGN_TOKENS.border};">
      <div style="font-family:${FONTS.heading};font-size:14px;font-weight:700;letter-spacing:-0.01em;color:${DESIGN_TOKENS.textPrimary};line-height:18px;">${title}</div>
    </td>
  </tr>
...
function render(props = {}) {
  ...
  const inner = variant === "dashboard"
    ? renderDashboardVariant(props)
    : renderChatVariant(props);

...
const schema = {
  ...
  description: "A simple list with bullet, tick, dash, arrow or number markers. Optional title and intro line; one or two columns. items is an array of plain strings, e.g. [\"Unlimited users\", \"Live chat included\"] or [\"Flights from Manchester\", \"7 nights half board\"]. Inline **bold** and [links](url) work.",
  fields: [
  ...
  composerHints: {
    whenToUse: [
      "What's included in a plan, or holiday inclusions (marker 'tick', columns '2' for short items)",

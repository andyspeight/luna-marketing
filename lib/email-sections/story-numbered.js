...
<tr><td ${outerBg} class="tg-pad-mobile" style="${outerStyle}">
  ${eyebrowRowHtml}
  <h2 style="font-family:${FONTS.heading};font-size:${headlineSize}px;font-weight:700;letter-spacing:-0.015em;line-height:1.25;color:${DESIGN_TOKENS.textPrimary};margin:0 0 14px 0;">${headline}</h2>
  ${bodyParagraphsHtml}
  ${imageRowHtml}
  ${ctaRowHtml}
</td></tr>`;

  ...
  <td style="padding:20px 0;${borderStyle}">
    <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr>
        ...
        <td valign="top">
          ${heading ? `<div style="font-family:${FONTS.heading};font-size:17px;font-weight:700;letter-spacing:-0.015em;color:${DESIGN_TOKENS.textPrimary};line-height:1.3;margin:3px 0 5px 0;">${heading}</div>` : ""}
          ${text ? `<div style="font-family:${FONTS.body};font-size:15px;line-height:1.55;color:${DESIGN_TOKENS.textSecondary};margin:0;">${text}</div>` : ""}
        </td>
      </tr>
    </table>
  </td>
  ...
  const headerHtml = `
    ...
    <tr>
      <td align="left" style="padding:0 0 18px 0;">
        <p style="font-family:${FONTS.body};font-size:${ledeSize}px;line-height:1.6;color:${DESIGN_TOKENS.textSecondary};margin:0;max-width:480px;">${lede}</p>
      </td>
    </tr>` : ""}`;

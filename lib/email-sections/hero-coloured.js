...
function render(props = {}, brand) {
  ...
  // one is set, push it to its natural edge.
  let metaRowHtml = "";
    ...
    <tr>
      <td style="padding:0 0 20px 0;">
        <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
          <tr>
            <td valign="middle" align="left" style="font-family:${FONTS.body};font-size:11px;font-weight:600;letter-spacing:0.10em;text-transform:uppercase;color:${eyebrowColour};line-height:16px;">${eyebrow}</td>
            <td valign="middle" align="right" style="font-family:${FONTS.body};font-size:11px;font-weight:600;letter-spacing:0.10em;text-transform:uppercase;color:${eyebrowColour};line-height:16px;">${dateLabel}</td>
          </tr>
        </table>
      </td>
    </tr>`;
    ...
    <tr>
      <td style="padding:24px 0 0 0;">
        <table role="presentation" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="${fg}" style="background-color:${fg};border-radius:6px;mso-padding-alt:12px 22px;">
              <a href="${ctaUrl}" style="display:inline-block;padding:12px 22px;font-family:${FONTS.body};font-size:14px;font-weight:600;color:${bg};text-decoration:none;border-radius:6px;line-height:1;">${ctaText}</a>
            </td>
          </tr>
        </table>
      </td>
  ...
  return `
<tr><td bgcolor="${bg}" class="tg-pad-mobile" style="background-color:${bg};padding:36px 36px 40px;">
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    ${metaRowHtml}
    <tr>
      <td style="padding:0;">
        <h1 class="tg-hero-headline" style="font-family:${FONTS.heading};font-size:34px;font-weight:800;letter-spacing:-0.025em;line-height:1.1;color:${fg};margin:0;mso-line-height-rule:exactly;">${headlineHtml}</h1>
      </td>
    </tr>
    ${subhead ? `
    <tr>
      <td style="padding:14px 0 0 0;">
        <p class="tg-hero-subhead" style="font-family:${FONTS.body};font-size:15px;font-weight:400;color:${fg};line-height:1.5;margin:0;opacity:0.92;">${subhead}</p>
      </td>
    </tr>` : ""}
    ${ctaRowHtml}
  </table>

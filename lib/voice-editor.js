...
11. BROKEN SENTENCES. Read every sentence aloud. Each one must parse as
    complete, plain English. A long verbless fragment ("The knowledge and the
    taste you bring to every booking finally visible to the person who hasn't
    booked with you yet.") is a HARD fault — it is missing its verb and makes
    the reader stop and re-read. Fix it by completing the sentence ("...is
    finally visible..."). Deliberate SHORT fragments that land as rhythm ("No
    spreadsheets. No late nights.") are fine. Anything that reads like a
    sentence that lost a word mid-edit is not.
...
- If it scores 8 or above AND has no fault from items 1, 2, 3, 6, 7, 10 or 11
  (the hard faults), return it UNCHANGED. Do not polish a good post into
  blandness. Leaving a strong post alone is the correct, expected outcome much
  of the time.

  ...
  "b2b-weekly": {
    ...
    sections: [
      ...
      },
      {
        type: "customer-story",
        required: false,
        purpose: "Case-study card (customer, result, quote, proof numbers) when the brief names a real customer. Never invent one."
      },
      {
        type: "pulse-stats",
        required: false,
      ...
      },
      {
        type: "callout",
        required: false,
        purpose: "One practical tip or takeaway pulled out of the copy in a tinted box. One per issue maximum."
      },
      {
        type: "calendar-grid",
        required: false,
      ...
      },
      {
        type: "signature",
        required: false,
        purpose: "Personal sign-off from the author (name + role from the brand record) just before the footer. Never invent a name."
      },
      {
        type: "footer-light",
        required: true,
  ...
  "marketing-newsletter": {
    ...
    sections: [
      ...
      },
      {
        type: "image-text",
        required: false,
        purpose: "Image beside text for a single hotel, product or destination spotlight. Two or three in a row with image_position alternating left / right make a zig-zag. Flag the image in imagesNeeded if none is available."
      },
      {
        type: "bullet-list",
        required: false,
        purpose: "What's included / highlights as a tick list (marker 'tick'). Only facts from the input — never invent inclusions."
      },
      {
      ...
      },
      {
        type: "callout",
        required: false,
        purpose: "One tip, deadline or reminder in a tinted box (tone 'amber' for dates). One per email maximum."
      },
      {
        type: "cta-banner",
        required: true,
  ...
  "product-launch": {
    ...
    sections: [
      ...
      },
      {
        type: "logo-strip",
        required: false,
        purpose: "'Trusted by' or 'Works with' logos under the hero. Only when logo URLs are supplied in the brief or Asset Library."
      },
      {
        type: "product-mockup",
        required: false,
      ...
      },
      {
        type: "image-text",
        required: false,
        purpose: "Product-in-action rows: one image-text per key feature with image_position alternating left / right. Use instead of features-section when product visuals exist or can be generated (style 'product-mockup')."
      },
      {
        type: "update-list",
        required: false,
        purpose: "When one email covers several changes, list them with new / improved / fixed / coming-soon tags instead of a hero per change."
      },
      {
        type: "pricing-cards",
        required: false,
        purpose: "Plan cards when the brief or Product Library includes pricing. Highlight the recommended plan. Never invent a price or inclusion."
      },
      {
        type: "stats-strip",
        required: false,
      ...
      },
      {
        type: "customer-story",
        required: false,
        purpose: "Case-study card as the proof beat when a named customer, result and quote are in the brief. Use instead of testimonial, not as well."
      },
      {
        type: "faq",
        required: false,
        purpose: "Two to four questions before the final CTA, only ones the Product Library actually answers."
      },
      {
        type: "cta-dark",
        required: true,

...
<tr><td bgcolor="${DESIGN_TOKENS.bgSecondary}" class="tg-pad-mobile" style="background-color:${DESIGN_TOKENS.bgSecondary};padding:36px 32px;border-bottom:1px solid ${DESIGN_TOKENS.border};">
  ${label ? `<div style="font-family:${FONTS.body};font-size:${labelSize}px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:${DESIGN_TOKENS.accent};margin:0 0 14px 0;line-height:${Math.round(labelSize * (14 / 10))}px;">${label}</div>` : ""}
  <div style="font-family:${FONTS.heading};font-size:${quoteSize}px;font-weight:500;line-height:${Math.round(quoteSize * (29 / 20))}px;letter-spacing:-0.015em;color:${DESIGN_TOKENS.textPrimary};margin:0 0 16px 0;font-style:italic;">
  ...
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
    <tr>
      ...
      <td style="padding:0 0 0 28px;">
        <div style="font-family:${FONTS.heading};font-size:${quoteSize}px;font-weight:500;line-height:${Math.round(quoteSize * (28 / 19))}px;letter-spacing:-0.015em;color:${DESIGN_TOKENS.textPrimary};margin:0 0 16px 0;font-style:italic;">${quote}</div>
        ${attributionHtml}
      </td>
    </tr>
  </table>

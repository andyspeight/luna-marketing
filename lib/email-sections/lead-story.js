  ...
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      <td style="padding:0 0 14px 0;">
        <h2${editAttr(editable, "headline")} style="font-family:${FONTS.heading};font-size:${headlineSize}px;font-weight:700;line-height:1.2;letter-spacing:-0.025em;color:${DESIGN_TOKENS.textPrimary};margin:0;">${headline}</h2>
      </td>
    </tr>
    ${deck ? `
    <tr>
    ...
    <tr>
      <td style="padding:24px 0 0 0;">
        <div${editAttr(editable, "body")}${richAttr(editable)} style="font-family:${FONTS.body};font-size:${bodySize}px;line-height:1.7;color:${DESIGN_TOKENS.textSecondary};">${body}</div>
      </td>
    </tr>` : ""}
    ${linkHtml}
  </table>

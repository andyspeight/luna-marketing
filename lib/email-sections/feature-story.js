  ...
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="${DESIGN_TOKENS.bgSecondary}" style="background-color:${DESIGN_TOKENS.bgSecondary};border:1px solid ${DESIGN_TOKENS.border};border-radius:16px;overflow:hidden;width:100%;">
    ...
    <tr>
      <td style="padding:32px;">
        <div style="font-family:${FONTS.heading};font-size:${bodyTitleSize}px;font-weight:700;line-height:${Math.round(bodyTitleSize * (28 / 22))}px;letter-spacing:-0.02em;color:${DESIGN_TOKENS.textPrimary};margin:0 0 12px 0;">${bodyTitle}</div>
        ${excerpt ? `<div style="font-family:${FONTS.body};font-size:${excerptSize}px;line-height:${Math.round(excerptSize * (25 / 15))}px;color:${DESIGN_TOKENS.textSecondary};margin:0 0 20px 0;">${excerpt}</div>` : ""}
        ${linkHtml}
      </td>
    </tr>
  </table>

...
const { escHtml, escAttr, safeUrl, fallback, scaleFont, safeHex } = require("./_helpers");
  ...
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%" style="position:relative;">
    ...
    <tr>
      <td style="padding:0 0 20px 0;">
        <span style="font-family:${FONTS.body};font-size:${eyebrowSize}px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;color:${DESIGN_TOKENS.accentLight};line-height:${Math.round(eyebrowSize * (14 / 12))}px;">${eyebrow}</span>
      </td>
    </tr>` : ""}
    <tr>
      <td style="padding:0 0 20px 0;">
        <h1 style="font-family:${FONTS.heading};font-size:${headlineSize}px;font-weight:800;line-height:1.02;letter-spacing:-0.04em;color:#ffffff;margin:0;mso-line-height-rule:exactly;">${headlineHtml}</h1>
      </td>
    </tr>
    ${deck ? `
    <tr>
      <td style="padding:0;">
        <p style="font-family:${FONTS.body};font-size:${deckSize}px;line-height:1.55;color:rgba(255,255,255,0.78);font-weight:400;letter-spacing:-0.005em;margin:0;max-width:480px;">${deck}</p>
      </td>
    </tr>` : ""}
    ${ctaHtml}
  </table>

    ...
    <table role="presentation" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;">
      <tr>
        <td bgcolor="${ctaBg}" align="center" style="background-color:${ctaBg};border-radius:999px;mso-padding-alt:16px 40px;">
          <a href="${url}"${editAttr(editable, "text")} style="display:inline-block;padding:16px 40px;font-family:${FONTS.body};font-size:${textSize}px;font-weight:700;${fontStyle}color:${ctaFg};text-decoration:none;border-radius:999px;line-height:1;">${text}</a>
        </td>
      </tr>
    </table>`;
  ...
  const subtextHtml = subtext
    ? `<tr>
        <td align="center" style="padding:12px 0 0 0;">
          <p${editAttr(editable, "subtext")} style="font-family:${FONTS.body};font-size:${subtextSize}px;font-style:italic;color:#888888;line-height:${Math.round(subtextSize * (18 / 12))}px;margin:0;">${subtext}</p>
        </td>
      </tr>`
    : "";

...
function render(props = {}, brand) {
  ...
  const wordmarkHtml = linkUrl
    ? `<a href="${linkUrl}" style="font-family:${serifStack};font-size:${wordmarkSize}px;font-style:italic;font-weight:700;color:${fg};text-decoration:none;letter-spacing:0.005em;line-height:1.2;">${wordmark}</a>`
    : `<span style="font-family:${serifStack};font-size:${wordmarkSize}px;font-style:italic;font-weight:700;color:${fg};letter-spacing:0.005em;line-height:1.2;">${wordmark}</span>`;

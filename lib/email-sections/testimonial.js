    ...
    <table role="presentation" border="0" cellspacing="0" cellpadding="0" align="center" style="margin:0 auto;">
      <tr>
        ...
        <td valign="middle" align="left">
          ${name ? `<div${editAttr(editable, "author.name")} style="font-family:${FONTS.body};font-size:14px;font-weight:600;color:${headingColour};line-height:1.4;margin:0;">${name}</div>` : ""}
          ${role ? `<div${editAttr(editable, "author.role")} style="font-family:${FONTS.body};font-size:12px;color:${bodyColour};line-height:1.4;margin:2px 0 0 0;">${role}</div>` : ""}
        </td>
      </tr>
    </table>` : "";
  ...
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
      <td align="center" style="padding:0 0 24px 0;">
        <p${editAttr(editable, "quote")} style="font-family:${FONTS.heading};font-size:${quoteSize}px;line-height:1.4;letter-spacing:-0.02em;color:${headingColour};font-weight:500;font-style:italic;margin:0 auto;max-width:480px;">&ldquo;${quote}&rdquo;</p>
      </td>
    </tr>
    ${authorBlock ? `
    <tr>
...
const schema = {
  ...
  fields: [
    ...
    { key: "heading_colour", label: "Quote & name colour", type: "colour", optional: true, defaultPreview: "#0F172A", help: "Leave empty to keep the default." },
    { key: "body_colour", label: "Role / company colour", type: "colour", optional: true, defaultPreview: "#475569", help: "Leave empty to keep the default." },

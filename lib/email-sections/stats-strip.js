...
<div style="text-align:center;">
  <div style="font-family:${FONTS.heading};font-size:${valueSize}px;font-weight:800;letter-spacing:-0.035em;line-height:1;color:${DESIGN_TOKENS.primary};margin:0 0 8px 0;font-variant-numeric:tabular-nums;">${value || "&nbsp;"}</div>

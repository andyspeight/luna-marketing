...
<tr><td bgcolor="${DESIGN_TOKENS.bgPrimary}" class="tg-pad-mobile" style="background-color:${DESIGN_TOKENS.bgPrimary};padding:32px 36px 20px;border-bottom:3px solid ${DESIGN_TOKENS.primary};">
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      <td style="padding:0;">
        <h1 style="font-family:${FONTS.heading};font-size:${titleSize}px;font-weight:800;letter-spacing:-0.035em;line-height:1;color:${DESIGN_TOKENS.primary};margin:0;mso-line-height-rule:exactly;">${title}</h1>
      </td>
    </tr>
    ${tagline ? `
    <tr>
      <td style="padding:8px 0 0 0;">
        <p style="font-family:${FONTS.body};font-size:${taglineSize}px;font-style:italic;letter-spacing:-0.005em;color:${DESIGN_TOKENS.textSecondary};line-height:${Math.round(taglineSize * (18 / 12))}px;margin:0;">${tagline}</p>
      </td>
    </tr>` : ""}
  </table>
</td></tr>`;

  ...
  const subheadRowHtml = subheadHtml
    ? `<tr>
        <td style="padding:14px 0 0 0;">
          <p style="font-family:${FONTS.body};font-size:14px;color:${base};line-height:1.5;margin:0;">${subheadHtml}</p>
        </td>
      </tr>`
    : "";
...
<tr><td class="tg-pad-mobile" style="padding:32px 36px 24px 36px;">
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
      <td>
        <h1 style="font-family:${serifStack};font-size:54px;font-weight:900;letter-spacing:-0.02em;line-height:1.0;color:${accent};margin:0;mso-line-height-rule:exactly;">${lineOne}</h1>
      </td>
    </tr>
    <tr>
      <td>
        <h1 style="font-family:${serifStack};font-size:54px;font-weight:900;letter-spacing:-0.02em;line-height:1.05;color:${base};margin:0;mso-line-height-rule:exactly;">${lineTwo}</h1>
      </td>
    </tr>
    ${subheadRowHtml}
    ${ruleHtml}

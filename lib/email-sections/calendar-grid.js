...
const { escHtml, escAttr, safeUrl, fallback, scaleFont } = require("./_helpers");
...
<tr><td bgcolor="${DESIGN_TOKENS.bgPrimary}" class="tg-pad-mobile" style="background-color:${DESIGN_TOKENS.bgPrimary};padding:36px;">
  <div style="font-family:${FONTS.heading};font-size:${titleSize}px;font-weight:700;letter-spacing:-0.02em;color:${DESIGN_TOKENS.textPrimary};line-height:1.2;margin:0 0 6px 0;">${title}</div>
  ${sub ? `<div style="font-family:${FONTS.body};font-size:${subSize}px;color:${DESIGN_TOKENS.textSecondary};line-height:1.5;margin:0 0 20px 0;">${sub}</div>` : `<div style="height:20px;line-height:20px;font-size:20px;">&nbsp;</div>`}

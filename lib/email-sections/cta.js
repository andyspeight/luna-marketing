...
function render(props = {}, brand, editable) {
  ...
  if (body) {
    inner += `<div${editAttr(editable, "body")} style="font-family:${FONTS.body};font-size:${bodySize}px;color:${bodyColor};line-height:${Math.round(bodySize * (24 / 15))}px;text-align:center;margin:0 0 24px 0;">${body}</div>`;
  } else {

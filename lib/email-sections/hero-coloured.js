...
const { escHtml, fallback, safeUrl, editAttr } = require("./_helpers");
  ...
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      <td style="padding:18px 0 0 0;">
        <p${subheadClass}${editAttr(editable, "subhead")} style="font-family:${FONTS.body};font-size:${subheadSize}px;font-weight:400;color:${fg};line-height:1.55;margin:0;opacity:0.92;">${subhead}</p>
      </td>
    </tr>` : ""}
    ${ctaRowHtml}
  </table>

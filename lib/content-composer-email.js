...
\`\`\`
{
  ...
  "previewText": "string, max 110 chars — complements the subject, doesn't repeat it",
  ...
  "imagesNeeded": [
    { "sectionIndex": 1, "slot": "image_url", "suggestion": "Apple-style mockup of a chat interface, navy + teal palette, no text overlay" }
  ],
  "warnings": [
    "Optional notes for the user — e.g. 'Audience hasn't been emailed in 35 days'"
  ]
}
\`\`\`
...
- imagesNeeded entries describe what image is needed at each empty image slot
- warnings are messages for the human reviewer about anything notable

...
2. Concrete content suggestions
   If the section content gives you headlines and key facts, use them. If there are gaps (real numbers, dates, sample customer names, sample product names), suggest plausible specifics. For Travelgenix, plausible looks like "247 verified properties", "12,847 trips analysed", "From £2,847pp", "Last analysed 3h ago", "Powered by Travelgenix Luna AI".
...
function buildUserMessage(input) {
  ...
  if (Array.isArray(sc.facts) && sc.facts.length > 0) {
    lines.push("- Key facts to surface in the imagery:");

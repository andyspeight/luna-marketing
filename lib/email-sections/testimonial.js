  ...
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
      <td align="center" style="padding:0 0 24px 0;">
        <p style="font-family:${FONTS.heading};font-size:22px;line-height:1.4;letter-spacing:-0.02em;color:${DESIGN_TOKENS.textPrimary};font-weight:500;font-style:italic;margin:0 auto;max-width:480px;">&ldquo;${quote}&rdquo;</p>
      </td>
    </tr>
    ${authorBlock ? `
    <tr>

...
function render(props = {}, brand) {
  ...
  const renderCard = (card) => {
    ...
    const titleHtml = title
      ? `<p style="font-family:${FONTS.heading};font-size:${titleSize}px;font-weight:600;color:${textColour};line-height:1.3;margin:14px 0 0 0;text-align:center;">${title}</p>`
      : "";

    const bodyHtml = body
      ? `<p style="font-family:${FONTS.body};font-size:${bodySize}px;color:${textColour};line-height:1.5;margin:6px 0 0 0;text-align:center;opacity:0.75;">${body}</p>`
      : "";

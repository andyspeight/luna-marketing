  ...
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      <td align="center" style="padding:0 0 12px 0;">
        <span style="font-family:${FONTS.body};font-size:11px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:${DESIGN_TOKENS.accent};line-height:14px;">${eyebrow}</span>
      </td>
    </tr>` : ""}
    ${title ? `
    <tr>
      <td align="center" style="padding:0 0 12px 0;">
        <h2 style="font-family:${FONTS.heading};font-size:30px;font-weight:700;line-height:1.2;letter-spacing:-0.025em;color:${DESIGN_TOKENS.textPrimary};margin:0;">${title}</h2>
      </td>
    </tr>` : ""}
    ${lede ? `
    <tr>
      <td align="center" style="padding:0 0 40px 0;">
        <p style="font-family:${FONTS.body};font-size:16px;line-height:1.6;color:${DESIGN_TOKENS.textSecondary};margin:0 auto;max-width:460px;text-align:center;">${lede}</p>
      </td>

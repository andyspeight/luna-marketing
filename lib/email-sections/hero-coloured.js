...
<tr><td bgcolor="${bg}" class="tg-pad-mobile" style="background-color:${bg};padding:52px 48px 56px;">
  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      <td style="padding:0;">
        <h1 class="tg-hero-headline" style="font-family:${FONTS.heading};font-size:40px;font-weight:800;letter-spacing:-0.03em;line-height:1.1;color:${fg};margin:0;mso-line-height-rule:exactly;">${headlineHtml}</h1>
      </td>
    </tr>
    ${subhead ? `
    <tr>
      <td style="padding:18px 0 0 0;">
        <p class="tg-hero-subhead" style="font-family:${FONTS.body};font-size:16px;font-weight:400;color:${fg};line-height:1.55;margin:0;opacity:0.92;">${subhead}</p>
      </td>
    </tr>` : ""}
    ${ctaRowHtml}
  </table>
